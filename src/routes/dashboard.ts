...
<body>
  <header class="app-header">
    ...
    <div class="app-header-nav">
      <button class="header-btn" onclick="window.location.href='/simulator'" aria-label="Simulator" title="Email Simulator">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="12" rx="2"/><circle cx="9" cy="10" r="1.5"/><circle cx="15" cy="10" r="1.5"/><path d="M8 16h8"/><line x1="12" y1="2" x2="12" y2="4"/></svg>
      </button>
