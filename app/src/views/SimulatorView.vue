...
.title { font-family: var(--font-serif); font-style: italic; font-weight: 500; font-variation-settings: 'opsz' 72; letter-spacing: -0.018em; line-height: 1.02; font-size: var(--step-4); color: var(--accent); margin: var(--space-2) 0 var(--space-4); text-wrap: balance; }
